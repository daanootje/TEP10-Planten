...
public interface LeveranciersApi {
    ...
    @RequestMapping(path = "{levcode}/bestellingen", method = RequestMethod.POST)
    ResponseEntity<Bestelling>  setBestellingAtLeverancier(@PathVariable Long levcode, @RequestBody Bestelling bestelling) throws NotFoundException;
